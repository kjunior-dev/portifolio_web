        ...
        >
            ...
            >
                <div className="flex items-start justify-between gap-4">
                    <div>
                        <p className="text-sm font-semibold text-cyan-700">{category}</p>
                ...
                <div className="mt-6 grid gap-6">
                    <div>
                        ...
                        <p className="mt-2 text-base leading-7 text-slate-700">{project.problemaResolvido}</p>
                    </div>
                    <div>
                        <h4 className="text-sm font-semibold uppercase tracking-[0.14em] text-slate-500">
                            Funcionalidades
                        ...
                        <ul className="mt-3 grid gap-2 sm:grid-cols-2">
                            {project.funcionalidades.map((feature) => (
                                <li key={feature.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6 text-slate-700">
                                    {feature.texto}
                                </li>
                            ))}
                        </ul>
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-base leading-7 text-slate-700">{project.minhaParticipacao}</p>
                    </div>
